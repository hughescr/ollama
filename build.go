...
// Flags
var (
	flagForce     = flag.Bool("f", false, "destroy and regenerate the dependencies")
	flagRebuild   = flag.Bool("r", false, "regenerate, do not destroy, the dependencies")
...
func buildEnv() []string {
	return append(os.Environ(),
		"GOARCH="+cmp.Or(*flagGOARCH, os.Getenv("OLLAMA_BUILD_TARGET_ARCH"), runtime.GOARCH),
	)
}
...
func buildLlammaCPP() error {
	...
	if isDirectory(filepath.Join("llm", "build")) && !*flagRebuild {
